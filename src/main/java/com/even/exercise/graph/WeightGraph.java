 ...
 * Project Name: ai
 * Des:
 * Created by Even on 2019/4/11 15:00
 */
public class WeightGraph {// 有向有权图的邻接表表示
    private LinkedList<Edge> adj[]; // 邻接表，记录了顶点与顶点之前的边
    private int v; // 顶点个数
    ...
    public void dijkstra(int s, int t) { // 从顶点 s 到顶点 t 的最短路径
        int[] predecessor = new int[this.v]; // 用来还原最短路径，记录指向当前顶点的前一个顶点
        Vertex[] vertexes = new Vertex[this.v];//表示顶点的数组
